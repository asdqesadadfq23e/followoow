...
(function() {
	...
	// "On Visible" animations.
		onvisible.add('#text01', { style: 'fade-left', speed: 1000, intensity: 1, delay: 0, replay: false });
		onvisible.add('#text02', { style: 'fade-left', speed: 1000, intensity: 1, delay: 0, replay: false });
		onvisible.add('#image01', { style: 'focus-image', speed: 1000, intensity: 5, delay: 0, replay: false });
